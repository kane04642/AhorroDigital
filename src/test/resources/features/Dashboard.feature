...
Característica: Validar funcionalidad dashboard
  ...
  Esquema del escenario: Validar plan quinquenal Avance Habilitación - Periodo
    ...
    Ejemplos:
      ...
      | TC550 - Validar plan quinquenal con material otros y categoría inversión | cliente | Quinquenal | 2022-2026 |      | AC       | Longitud  |
      | TC551 - Validar plan quinquenal con material PE y categoría longitud     | cliente | Quinquenal | 2022-2026 |      | PE       | Longitud  |
      | TC552 - Validar plan quinquenal con material AC y categoría longitud     | cliente | Quinquenal | 2022-2026 |      | Otros    | Longitud  |
  ...
  Esquema del escenario: Validar plan anual Avance Habilitación - Periodo
    ...
    Ejemplos:
      ...
      | TC556 - Validar plan anual con material otros y categoría longitud  | cliente | Anual | 2023 | AC       | Longitud  |
      | TC557 - Validar plan anual con material PE y categoría longitud     | cliente | Anual | 2023 | PE       | Longitud  |
      | TC558 - Validar plan anual con material AC y categoría longitud     | cliente | Anual | 2023 | Otros    | Longitud  |