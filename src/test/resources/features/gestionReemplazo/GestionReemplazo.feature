...
Característica: Validar funcionalidad gestiòn de reemplazo - impedimentos
  ...
  Esquema del escenario: Búsqueda por por mas filtros
    ...
    Ejemplos:
      ...
      | TC640 - Búsqueda por Importancia                         |             | Seleccionar | Seleccionar     | Seleccionar                 | Seleccionar        |          |          |          |          |          |               |              |               | Seleccionar      | Seleccionar     | Seleccionar       | Seleccionar      | Seeccionar  | Si          |                             |                  |
      | TC641 - Búsqueda por Usuarios Responsables               |             | Seleccionar | Seleccionar     | Seleccionar                 | Seleccionar        |          |          |          |          |          |               |              |               | Seleccionar      | Seleccionar     | Seleccionar       | Seleccionar      | Seeccionar  | Seeccionar  | Administrador Administrador |                  |
